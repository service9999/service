// backend/modules/marketIntelligence.js
...
export class MarketIntelligence {
    ...
    async handleAlerts(monitor, alerts) {
        for (const alert of alerts) {
            ...
            // Store alert
            this.priceAlerts.set(`alert_${Date.now()}`, {
                ...alert,
    ...
    async cleanup() {
        // Clear all intervals
        if (this.updateIntervalsIds.trending) clearInterval(this.updateIntervalsIds.trending);
        if (this.updateIntervalsIds.prices) clearInterval(this.updateIntervalsIds.prices);
        if (this.updateIntervalsIds.social) clearInterval(this.updateIntervalsIds.social);
        if (this.updateIntervalsIds.alerts) clearInterval(this.updateIntervalsIds.alerts);
